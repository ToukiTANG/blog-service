package com.touki.blog.util.markdown;

import com.touki.blog.util.markdown.ext.cover.CoverExtension;
import com.touki.blog.util.markdown.ext.heimu.HeimuExtension;
...
public abstract class MarkdownUtil {
    ...
    private static final Set<Extension> HEADING_ANCHOR_EXTENSIONS =
